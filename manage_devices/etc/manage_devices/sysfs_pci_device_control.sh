...
SYSFS_DEV_ID_VENDOR_ATTR_RELATIVE_PATH="vendor";
SYSFS_DEV_ID_PRODUCT_ATTR_RELATIVE_PATH="device";
...
SYSFS_DEV_RESET_RELATIVE_PATH="reset";
...
do
	case "$1" in
		...
		--power-wakeup)							DEV_PROPERTY_ATTR_RELATIVE_PATH="$SYSFS_DEV_POWER_WAKEUP_RELATIVE_PATH";
																...
																DEV_PROPERTY_ATTR_STATE="$1";
																;;
		--reset)										DEV_PROPERTY_ATTR_RELATIVE_PATH="$SYSFS_DEV_RESET_RELATIVE_PATH"
																;;
		*)													DEV_ID="$1"
																;;
	esac;
